...
namespace CCr
{
    public partial class AsesorCapacitaciones : AsesorTemplate
    {
        ...
        public AsesorCapacitaciones()
        {
            InitializeComponent();
        }

        private void AsesorCapacitaciones_Load(object sender, EventArgs e)
        {
            cargar(); refresh();
        ...
        private void cmbCapacita_SelectedIndexChanged(object sender, EventArgs e)
        {
        ...
        private void dgvCapacitaciones_CellContentClick(object sender, DataGridViewCellEventArgs e)
        {
